  ...
  return (
    <Container small>
      ...
      <BlogRow>
        ...
        <Col large>
          <p>
            With my recent efforts in product management I increasingly came in
            contact with the technique of prototyping and testing. So, over the
            weekend, I wanted to make a little prototyping project and came
            across the online shop of Bonvelo. I thought that their product page
            was worth a try, to experiment and give it a redesign. The result is
            a high-fidelity clickable prototype. <br />
          </p>
        </Col>
      </BlogRow>
      <BlogRow>
      ...
      <BlogRow>
        ...
        <Col large>
          <p>
            ...
            opinion. Hence, if this were a real project, it should be subjected
            to user testing and data gathering. Testing usability of the
            prototype reveals whether users actually have a better shopping
            experience. Do users experience it as a substantially better
            solution than the previous version? By running a user test, we can
            let users drive the prototype and see which direction they take. The
            prototype could then either pass or fail and should be itereted
            subsquently.
          </p>
          <p>
            I spent 4h on the redesign, 4h on the code and 6h on the video.
            Tools I used: Figma, NextJS, Framer Motion Make sure to checkout the
            bikes of Bonvelo. I own one myself and can truly recommend!
          </p>
        </Col>
      </BlogRow>
    </Container>
